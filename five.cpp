...
void five::on_comboBox_activated(const QString &arg1)
{
...
if(text=="Q1")
{
             connopen();
             QSqlQuery qry;
             qry.prepare("select ques from dia4 where qno=\'"+ text+"\'");
...
void five::on_pushButton_clicked(QString sty)
{
    ...
    if(sty=="Q1")
    {
        ...
        QSqlQuery qr;
        qr.prepare("select one,two,three,four,ans from dia4 where qno=\'"+ sty+"\'");
...
void five::on_pushButton_2_clicked()
{
     QString teext = ui->comboBox->currentText();
     connopen();

     QSqlQuery qr;
     qr.prepare("select one,two,three,four,ans from dia4 where qno=\'"+ teext+"\'");
