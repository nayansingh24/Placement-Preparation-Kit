...
void two::on_comboBox_activated(const QString &arg1)
{
...
if(text=="Q1")
{
             connopen();
             QSqlQuery qry;
             qry.prepare("select ques from dia where qno=\'"+ text+"\'");
...
void two::on_pushButton_clicked(QString sty)
{
    ...
    if(sty=="Q1")
    {
        ...
        QSqlQuery qr;
        qr.prepare("select one,two,three,four,ans from dia where qno=\'"+ sty+"\'");
...
void two::on_pushButton_2_clicked()
{
     ...
     QSqlQuery qr;
     qr.prepare("select one,two,three,four,ans from dia where qno=\'"+ teext+"\'");
